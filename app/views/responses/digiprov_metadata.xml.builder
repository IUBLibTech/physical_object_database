...
xml.pod("xmlns:xsi" => "http://www.w3.org/2001/XMLSchema-instance") do
   if @success
     ...
     xml.data do
       ...
       xml.tape_type (@tm.respond_to?(:tape_type) ? @tm.tape_type : "")
       ...
       xml.noise_reduction (@tm.respond_to?(:noise_reduction) ? @tm.noise_reduction : "")
       xml.format_duration (@tm.respond_to?(:format_duration) ? @tm.format_duration : "")
