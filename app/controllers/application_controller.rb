  ...
  private
    ...
    def tm_params
      params.require(:tm).permit(
        ...
        :zero_point46875_ips,
        # fields for film
        :gauge, :projection_print, :a_roll, :b_roll, :c_roll, :d_roll, :answer_print, :camera_original, :composite, :duplicate, :edited, :fine_grain_master, :intermediate, :kinescope, :magnetic_track, :master, :mezzanine, :negative, :optical_sound_track, :original, :outs_and_trims, :positive, :reversal, :work_print, :separation_master, :mixed_generation, :original_camera, :footage, :acetate, :polyester, :nitrate, :mixed, :frame_rate, :bw, :toned, :tinted, :hand_coloring, :stencil_coloring, :color, :ektachrome, :kodachrome, :technicolor, :anscochrome, :eco, :eastman, :anamorphic, :sound, :optical, :optical_variable_area, :optical_variable_density, :magnetic, :digital_sdds, :digital_dts, :digital_dolby_digital, :sound_on_separate_media, :mixed_sound_format, :clean, :resolution, :workflow, :on_demand, :return_on_original_reel, :brittle, :channeling, :color_fade, :cue_marks, :edge_damage, :holes, :peeling, :perforation_damage, :rusty, :scratches, :soundtrack_damage, :splice_damage, :stains, :sticky, :tape_residue, :tearing, :warp, :water_damage, :poor_wind, :not_on_core_or_reel, :lacquer_treated, :replasticized, :dusty, :spoking, :mold, :shrinkage, :ad_strip, :missing_footage, :miscellaneous, :return_to, :one_point33, :one_point37, :one_point66, :one_point85, :two_point35, :two_point39, :two_point59, :sound_mono, :sound_stereo, :sound_surround, :sound_multi_track, :sound_dual,
        ...
        # fields for film
        :gauge => [], :projection_print => [], :a_roll => [], :b_roll => [], :c_roll => [], :d_roll => [], :answer_print => [], :camera_original => [], :composite => [], :duplicate => [], :edited => [], :fine_grain_master => [], :intermediate => [], :kinescope => [], :magnetic_track => [], :master => [], :mezzanine => [], :negative => [], :optical_sound_track => [], :original => [], :outs_and_trims => [], :positive => [], :reversal => [], :work_print => [], :separation_master => [], :mixed_generation => [], :original_camera => [], :acetate => [], :polyester => [], :nitrate => [], :mixed => [], :frame_rate => [], :bw => [], :toned => [], :tinted => [], :hand_coloring => [], :stencil_coloring => [], :color => [], :ektachrome => [], :kodachrome => [], :technicolor => [], :anscochrome => [], :eco => [], :eastman => [], :anamorphic => [], :sound => [], :optical => [], :optical_variable_area => [], :optical_variable_density => [], :magnetic => [], :digital_sdds => [], :digital_dts => [], :digital_dolby_digital => [], :sound_on_separate_media => [], :mixed_sound_format => [], :clean => [], :resolution => [], :workflow => [], :on_demand => [], :return_on_original_reel => [], :brittle => [], :channeling => [], :color_fade => [], :cue_marks => [], :edge_damage => [], :holes => [], :peeling => [], :perforation_damage => [], :rusty => [], :scratches => [], :soundtrack_damage => [], :splice_damage => [], :stains => [], :sticky => [], :tape_residue => [], :tearing => [], :warp => [], :water_damage => [], :poor_wind => [], :not_on_core_or_reel => [], :lacquer_treated => [], :replasticized => [], :dusty => [], :spoking => [], :mold => [], :shrinkage => [], :ad_strip => [], :one_point33 => [], :one_point37 => [], :one_point66 => [], :one_point85 => [], :two_point35 => [], :two_point39 => [], :two_point59 => [], :sound_mono => [], :sound_stereo => [], :sound_surround => [], :sound_multi_track => [], :sound_dual => []
        )
    end
